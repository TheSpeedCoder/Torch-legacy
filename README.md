...
* Current developing version:  1.8.8
* Recommanded(stable) version: R0.1.1-RELEASE
...
* Download the binary file: *[Click Here](http://t.im/torch)*, and use *Torch-1.8.8-R0.x.jar*, to start server directly.
* Just enjoy Torch! :)
...
* First build **TacoSpigot [(1.8.8 branch)](https://github.com/TacoSpigot/TacoSpigot/tree/version/1.8.8)**, and replace the patches manually
* run `./applypatches.sh`
